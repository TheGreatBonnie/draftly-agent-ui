...
## Corpus Check
- 99 files · ~752,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 377 nodes · 684 edges · 19 communities (14 shown, 5 thin omitted)
...
## Knowledge Gaps
- **109 isolated node(s):** `iconMap`, `agentIcons`, `agentTones`, `toc`, `quality` (+104 more)
