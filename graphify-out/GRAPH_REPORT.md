...
## Corpus Check
- 180 files · ~778,536 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 757 nodes · 1530 edges · 43 communities (36 shown, 7 thin omitted)
...
### Community 37 - "ui.tsx"
Cohesion: 0.15
Nodes (8): Page(), statusTone(), ReviewActions(), Button(), EmptyState(), MockDialog(), Skeleton(), reviews

### Community 39 - "mock-data.ts"
Cohesion: 0.08
Nodes (15): activity, quality, toc, tabs, Badge(), TabItem, Tabs(), activityItems (+7 more)
...
Cohesion: 0.29
Nodes (6): available, connected, Page(), slug(), SectionTitle(), integrations
...
- **Why does `Card()` connect `Card` to `settings/[section]/page.tsx`, `settings/page.tsx`, `overview-cards.tsx`, `section-subpage.tsx`, `ui.tsx`, `mock-data.ts`, `knowledge/page.tsx`, `(dashboard)/integrations/page.tsx`, `agents/page.tsx`, `reviews/page.tsx`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `Button()` connect `ui.tsx` to `Card`, `settings/[section]/page.tsx`, `settings/page.tsx`, `section-subpage.tsx`, `mock-data.ts`, `knowledge/page.tsx`, `(dashboard)/integrations/page.tsx`, `agents/page.tsx`, `reviews/page.tsx`?**
