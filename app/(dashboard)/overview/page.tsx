      ...
      : range === "Today"
        ...
        : Array.from({ length: Math.min(7, values.length) }, (_, index) => {
            const pointIndex = Math.round(
              (index * (values.length - 1)) / (Math.min(7, values.length) - 1),
            );
                  ...
                  return (
                    <div
                      ...
                      <button
                        ...
                        style={{
                          height: `${Math.max(5, (total / 40) * 100)}%`,
                        }}>
                        <span
                          className="w-full bg-blue-600"
                          style={{
                            height: `${(value.created / total) * 100}%`,
                          }}
                        />
                        <span
                          className="w-full bg-indigo-400"
                          style={{
                            height: `${(value.updated / total) * 100}%`,
                          }}
                        />
                        <span
                          className="w-full bg-emerald-400"
                          style={{
                            height: `${(value.reviewed / total) * 100}%`,
                          }}
                        />
                        <span
                          className="w-full bg-blue-200"
                          style={{
                            height: `${(value.published / total) * 100}%`,
                          }}
                        />
...
function IntegrationCardIllustration() {
  return (
    <svg
      ...
      <path
        d="m103 28 2.7 6.3 6.3 2.7-6.3 2.7-2.7 6.3-2.7-6.3-6.3-2.7 6.3-2.7 2.7-6.3Z"
        fill="#6E46ED"
      />
      <path
        d="m89 47 1.4 3.3 3.3 1.4-3.3 1.4-1.4 3.3-1.4-3.3-3.3-1.4 3.3-1.4L89 47Z"
        fill="#9A7BFF"
      />
