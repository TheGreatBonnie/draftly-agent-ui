  ...
  return (
    <>
      ...
      <PageHeader
        ...
        subtitle="Complete execution trace for PR #142 — Add OAuth 2.0 support."
        actions={
          <Badge tone="green">
      ...
      <Tabs
        active="Timeline"
        items={["Timeline", "Inputs", "Outputs", "Evaluations", "Logs"]}
      />
      <div className="mt-4 grid gap-4 lg:grid-cols-[1fr_300px]">
        <Card className="p-5">
          <h3 className="font-semibold">Run timeline</h3>
          <div className="relative mt-5 space-y-5 before:absolute before:bottom-4 before:left-[19px] before:top-4 before:w-px before:bg-slate-200">
            {workflowSteps.map((s, i) => (
              <div key={s.name} className="relative flex gap-3">
                <div className="z-10 grid h-10 w-10 place-items-center rounded-full bg-emerald-50 text-emerald-600">
                ...
                <div className="flex-1 rounded-xl border border-slate-100 p-3">
                  <div className="flex justify-between gap-3">
                    ...
                    <span className="text-xs text-slate-400">
                      10:24:{String(i * 10 + 1).padStart(2, "0")}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-4">
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-semibold">PR #142</div>
