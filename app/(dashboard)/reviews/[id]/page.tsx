        ...
        <div>
          ...
          <div className="mt-4 grid gap-3 text-xs sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="flex gap-2">
              ...
              <span>
                Aug 29, 2026, 10:24 AM
                <br />
                <b className="text-foreground">Generated {review.updated}</b>
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[1.55fr_.9fr]">
        <div className="min-w-0 space-y-4">
          <Card className="min-w-0">
            ...
            <p className="px-4 pt-2 text-sm leading-6 text-foreground-secondary">
              {review.description} Draftly generated the proposed document below
              for human review.
            </p>
        ...
        <div className="min-w-0 space-y-4">
          ...
          <Card>
            ...
            <div className="p-4">
              <textarea
                className="h-24 w-full rounded-lg border border-border bg-input p-3 text-sm outline-none"
