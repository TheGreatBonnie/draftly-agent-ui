...
const knowledgeSources: Array<{
  ...
  {
    name: "Website",
    detail: "https://authly.com",
    synced: "5 hours ago",
    provider: "website",
  },
  {
    name: "Linear",
    detail: "Product issues",
    synced: "1 day ago",
    provider: "linear",
  },
];
...
function SourceLogo({ provider }: { provider: SourceProvider }) {
  if (provider === "github") {
    return (
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
        className="h-7 w-7 fill-slate-950 dark:fill-white">
  ...
  if (provider === "discord") {
    return (
      <svg aria-hidden="true" viewBox="0 0 28 28" className="h-7 w-7">
        ...
        <path
          d="M20.4 8.9a15 15 0 0 0-3.7-1.2l-.5 1a13.8 13.8 0 0 0-4.4 0l-.5-1a15 15 0 0 0-3.7 1.2C5.3 12.3 4.7 15.6 5 18.8a15.2 15.2 0 0 0 4.5 2.3l1.1-1.5a9.7 9.7 0 0 1-1.7-.8l.4-.3a10.8 10.8 0 0 0 9.4 0l.4.3c-.6.3-1.1.6-1.7.8l1.1 1.5a15.2 15.2 0 0 0 4.5-2.3c.4-3.7-.7-7-2.6-9.9ZM11.1 16.9c-1 0-1.8-.9-1.8-2s.8-2 1.8-2 1.8.9 1.8 2-.8 2-1.8 2Zm5.8 0c-1 0-1.8-.9-1.8-2s.8-2 1.8-2 1.8.9 1.8 2-.8 2-1.8 2Z"
          fill="white"
        />
      </svg>
    );
  ...
  if (provider === "notion") {
    return (
      <svg aria-hidden="true" viewBox="0 0 28 28" className="h-7 w-7">
        ...
        />
        <path
          d="M8 7.5h7.2l5 6.2V9.8l-2-.4V7.5H24v1.9l-1.8.4v11h-2.4L11.1 10v8.1l2.3.5v1.8H7v-1.8l2-.5V9.8L8 9.4V7.5Z"
          fill="#111827"
        />
      </svg>
    );
  ...
  if (provider === "linear") {
    return (
      <svg aria-hidden="true" viewBox="0 0 28 28" className="h-7 w-7">
        ...
        <path
          d="m6.3 11.1 10.6 10.6a8.2 8.2 0 0 1-10.6-10.6Zm.5-2.5 12.6 12.6c.6-.5 1.1-1.1 1.5-1.7L8.5 7.1c-.6.4-1.2.9-1.7 1.5Zm3.6-2.4 11.4 11.4c.3-.8.5-1.6.6-2.5L12.9 5.6c-.9.1-1.7.3-2.5.6Zm5.6-.4 6.2 6.2A8.2 8.2 0 0 0 16 5.8Z"
          fill="white"
        />
      </svg>
    );
  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 28 28" className="h-7 w-7">
      ...
      <path
        d="M7 14h14M14 7c2 2.1 3 4.4 3 7s-1 4.9-3 7c-2-2.1-3-4.4-3-7s1-4.9 3-7Z"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
                      ...
                      <div
                        ...
                        <div className="flex items-center gap-2">
                          <span className="grid h-5 w-5 shrink-0 place-items-center [&>svg]:h-5 [&>svg]:w-5">
                            <SourceLogo
                              provider={source.toLowerCase() as SourceProvider}
                            />
                          </span>
                          <span>{source}</span>
                        </div>
