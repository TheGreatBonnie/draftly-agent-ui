...
function BonnieAvatar() {
  return (
    <svg
      ...
      <path
        d="M6.5 36c.8-8.1 5.1-12.1 11.5-12.1S28.7 27.9 29.5 36h-23Z"
        fill="#172236"
      />
      <ellipse cx="18" cy="17.2" rx="7.2" ry="8.5" fill="#D99670" />
      <path
        d="M10.1 18.5C8.9 12.4 11.4 6 18.3 6c6.3 0 9 4.6 8.1 11.2-1.8-1.6-3.2-4.1-3.8-7.2-2.5 3.5-6.7 5.8-12.5 6.7v1.8Z"
        fill="#3B211A"
      />
      <path
        d="M10.6 14c.1 7.5 1.2 12.3 4.3 15.6-5.1-1.7-7-6-6.7-10.7.2-2.5.8-4.1 2.4-4.9Zm14.8-1.1c2.2 2.1 2.8 5.5 2.1 8.8-.8 3.8-2.7 6.3-5.9 7.8 2.2-3.8 3.3-9.4 3.8-16.6Z"
        fill="#2B1714"
      />
      <circle cx="15.3" cy="17.4" r=".7" fill="#3D251F" />
      <circle cx="20.9" cy="17.4" r=".7" fill="#3D251F" />
      <path
        d="M16 21.3c1.2.9 2.8.9 4 0"
        stroke="#8F4B43"
        strokeWidth="1"
        strokeLinecap="round"
      />
