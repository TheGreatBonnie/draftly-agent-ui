...
export function ReviewDetailPage({ id }: { id: string }) {
  ...
  return <>
    ...
    <div className="flex flex-wrap items-center justify-between border-b border-border"><Tabs active="Overview" items={["Overview", "Proposed changes", "Evidence", "Evaluation", "Agent activity", "Comments"]} /><div className="mb-2"><ReviewActions /></div></div>
